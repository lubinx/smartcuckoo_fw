...
//          <o> Slewrate (0~7)
    #define GPIOA_SLEWRATE              (7)
//      <h> PULL-UP when initialize / disabled
//          <q> PA00
    #define PA00_DISABLE_PULL_UP        (0)
//          <q> PA01
...
//              <o1> Maximum advertising interval
    #define BLUETOOTH_ADV_MIN_INTERVAL  (500)
    #define BLUETOOTH_ADV_MAX_INTERVAL  (500)
//          </h>
//      </h>
//  </h>
//--------------------------------------------------------------------------
